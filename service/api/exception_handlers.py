...
async def http_error_handler(request: Request, exc: Union[HTTPException, Exception]) -> JSONResponse:
    app_logger.error(str(exc))
...
async def app_exception_handler(
    request: Request,
    exc: Union[AppException, Exception],
) -> JSONResponse:
    errors = [
        Error(
...
def add_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(ModelNotFoundError, app_exception_handler)
